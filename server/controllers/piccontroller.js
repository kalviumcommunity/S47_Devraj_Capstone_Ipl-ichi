...
//         const dest = path.join(__dirname, '..', 'storage', 'pic');
//         cb(null, dest);
//     },
...
//         if (existingFilename) {
//           const imagePath = path.join(__dirname, '..', 'storage', 'pic', existingFilename);
//           try {
...
//         }
//         const imagePath = path.join(__dirname, '..', 'storage', 'pic',user.pic.filename);
